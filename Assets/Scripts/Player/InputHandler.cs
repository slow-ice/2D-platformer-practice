...
public class InputHandler : MonoBehaviour
{
    ...
    private void ResetSecondAttack(UnityEngine.InputSystem.InputAction.CallbackContext obj) => AttackInputs[(int)CombatInputs.Secondary] = false;

    private void OnSecondAttackInput(UnityEngine.InputSystem.InputAction.CallbackContext obj) => AttackInputs[(int)CombatInputs.Secondary] = true;


    private void ResetPrimaryAttack(UnityEngine.InputSystem.InputAction.CallbackContext obj) => AttackInputs[(int)CombatInputs.Primary] = false;

    private void OnPrimaryAttackInput(UnityEngine.InputSystem.InputAction.CallbackContext obj) => AttackInputs[(int)CombatInputs.Primary] = true;
    ...
    private void OnJumpButtonUp(UnityEngine.InputSystem.InputAction.CallbackContext obj) => jumpButtonUp = true;

    private void ResetMoveInput(UnityEngine.InputSystem.InputAction.CallbackContext obj) => movementInput = Vector2.zero;

    private void OnMoveInput(UnityEngine.InputSystem.InputAction.CallbackContext obj) => movementInput = obj.ReadValue<Vector2>();
